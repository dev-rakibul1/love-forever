<template>
  <footer class="bg-pink-200 text-gray-500 text-center py-10 relative footer-animate">
    <!-- Logo and Title -->
    <div class="relative" style="z-index: 1">
      <div class="flex flex-col items-center theme-container" style="z-index: 1">
        ...
        <p class="text-sm max-w-xl mx-auto mb-6 leading-relaxed">
          ...
          and unity. It's a journey of togetherness, embracing individuality while building a
          lasting bond through commitment and collaboration.
        </p>
        ...
        <div class="md:flex items-center justify-between w-full mt-12">
          ...
          <div class="text-xs mb-4">
            © Copyright 2023 by
            <span class="text-pink-500 font-semibold">Forever</span> - Design by BPS.
          </div>
