<template>
  <footer class="bg-pink-200 text-gray-500 text-center py-10 relative">
    <!-- Logo and Title -->
    <div class="flex flex-col items-center theme-container" style="z-index: 1">
      <div class="flex items-center justify-center mb-4">
        ...
        <!-- Title -->
        <h1 class="text-red-800 font-bold text-2xl ml-2 flex justify-center items-center">
          <svg
            fill="#000000"
            height="64px"
            width="64px"
      ...
      <!-- Description -->
      <p class="text-sm max-w-xl mx-auto mb-6 leading-relaxed">
        Love Partnership is built on trust, respect, and shared dreams, fostering growth, support,
        and unity. It's a journey of togetherness, embracing individuality while building a lasting
        bond through commitment and collaboration.
      </p>

      <!-- Social Icons -->
      <div class="flex space-x-6 mb-6">
        <a href="#" class="text-gray-400 hover:text-red-800">
      ...
      <div class="md:flex items-center justify-between w-full mt-12">
        <!-- Copyright -->
        <div class="text-xs mb-4">
          © Copyright 2023 by
          <span class="text-red-800 font-semibold">Forever</span> - Design by BPS.
        </div>

        <!-- Footer Links -->
        <div class="text-xs flex space-x-6 justify-center text-gray-500 hover:text-gray-700">
    ...
    <div class="w-full flex justify-center items-center" style="z-index: -5">
      <img src="@/assets/image/love.png" alt="shape" class="w-[250px] home-love-shape" />
    </div>
  </footer>
</template>
